...
pub const ggml_unary_op_GGML_UNARY_OP_COUNT: ggml_unary_op = 16;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct whisper_token_candidate {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of whisper_token_candidate"][::std::mem::size_of::<whisper_token_candidate>() - 12usize];
    ["Alignment of whisper_token_candidate"]
        [::std::mem::align_of::<whisper_token_candidate>() - 4usize];
    ["Offset of field: whisper_token_candidate::id"]
        [::std::mem::offset_of!(whisper_token_candidate, id) - 0usize];
    ["Offset of field: whisper_token_candidate::p"]
        [::std::mem::offset_of!(whisper_token_candidate, p) - 4usize];
    ["Offset of field: whisper_token_candidate::plog"]
        [::std::mem::offset_of!(whisper_token_candidate, plog) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct whisper_full_params {
    ...
    pub capture_top_candidates: bool,
    pub n_top_candidates: ::std::os::raw::c_int,
    pub debug_mode: bool,
    ...
    pub forced_tokens: *const whisper_token,
    pub forced_n_tokens: ::std::os::raw::c_int,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of whisper_full_params"][::std::mem::size_of::<whisper_full_params>() - 328usize];
    ...
    ["Offset of field: whisper_full_params::capture_top_candidates"]
        [::std::mem::offset_of!(whisper_full_params, capture_top_candidates) - 52usize];
    ["Offset of field: whisper_full_params::n_top_candidates"]
        [::std::mem::offset_of!(whisper_full_params, n_top_candidates) - 56usize];
    ["Offset of field: whisper_full_params::debug_mode"]
        [::std::mem::offset_of!(whisper_full_params, debug_mode) - 60usize];
    ["Offset of field: whisper_full_params::audio_ctx"]
        [::std::mem::offset_of!(whisper_full_params, audio_ctx) - 64usize];
    ["Offset of field: whisper_full_params::skip_encode"]
        [::std::mem::offset_of!(whisper_full_params, skip_encode) - 68usize];
    ["Offset of field: whisper_full_params::tdrz_enable"]
        [::std::mem::offset_of!(whisper_full_params, tdrz_enable) - 69usize];
    ["Offset of field: whisper_full_params::suppress_regex"]
        [::std::mem::offset_of!(whisper_full_params, suppress_regex) - 72usize];
    ["Offset of field: whisper_full_params::initial_prompt"]
        [::std::mem::offset_of!(whisper_full_params, initial_prompt) - 80usize];
    ["Offset of field: whisper_full_params::carry_initial_prompt"]
        [::std::mem::offset_of!(whisper_full_params, carry_initial_prompt) - 88usize];
    ["Offset of field: whisper_full_params::prompt_tokens"]
        [::std::mem::offset_of!(whisper_full_params, prompt_tokens) - 96usize];
    ["Offset of field: whisper_full_params::prompt_n_tokens"]
        [::std::mem::offset_of!(whisper_full_params, prompt_n_tokens) - 104usize];
    ["Offset of field: whisper_full_params::forced_tokens"]
        [::std::mem::offset_of!(whisper_full_params, forced_tokens) - 112usize];
    ["Offset of field: whisper_full_params::forced_n_tokens"]
        [::std::mem::offset_of!(whisper_full_params, forced_n_tokens) - 120usize];
    ["Offset of field: whisper_full_params::language"]
        [::std::mem::offset_of!(whisper_full_params, language) - 128usize];
    ["Offset of field: whisper_full_params::detect_language"]
        [::std::mem::offset_of!(whisper_full_params, detect_language) - 136usize];
    ["Offset of field: whisper_full_params::suppress_blank"]
        [::std::mem::offset_of!(whisper_full_params, suppress_blank) - 137usize];
    ["Offset of field: whisper_full_params::suppress_nst"]
        [::std::mem::offset_of!(whisper_full_params, suppress_nst) - 138usize];
    ["Offset of field: whisper_full_params::temperature"]
        [::std::mem::offset_of!(whisper_full_params, temperature) - 140usize];
    ["Offset of field: whisper_full_params::max_initial_ts"]
        [::std::mem::offset_of!(whisper_full_params, max_initial_ts) - 144usize];
    ["Offset of field: whisper_full_params::length_penalty"]
        [::std::mem::offset_of!(whisper_full_params, length_penalty) - 148usize];
    ["Offset of field: whisper_full_params::temperature_inc"]
        [::std::mem::offset_of!(whisper_full_params, temperature_inc) - 152usize];
    ["Offset of field: whisper_full_params::entropy_thold"]
        [::std::mem::offset_of!(whisper_full_params, entropy_thold) - 156usize];
    ["Offset of field: whisper_full_params::logprob_thold"]
        [::std::mem::offset_of!(whisper_full_params, logprob_thold) - 160usize];
    ["Offset of field: whisper_full_params::no_speech_thold"]
        [::std::mem::offset_of!(whisper_full_params, no_speech_thold) - 164usize];
    ["Offset of field: whisper_full_params::greedy"]
        [::std::mem::offset_of!(whisper_full_params, greedy) - 168usize];
    ["Offset of field: whisper_full_params::beam_search"]
        [::std::mem::offset_of!(whisper_full_params, beam_search) - 172usize];
    ["Offset of field: whisper_full_params::new_segment_callback"]
        [::std::mem::offset_of!(whisper_full_params, new_segment_callback) - 184usize];
    ["Offset of field: whisper_full_params::new_segment_callback_user_data"]
        [::std::mem::offset_of!(whisper_full_params, new_segment_callback_user_data) - 192usize];
    ["Offset of field: whisper_full_params::progress_callback"]
        [::std::mem::offset_of!(whisper_full_params, progress_callback) - 200usize];
    ["Offset of field: whisper_full_params::progress_callback_user_data"]
        [::std::mem::offset_of!(whisper_full_params, progress_callback_user_data) - 208usize];
    ["Offset of field: whisper_full_params::encoder_begin_callback"]
        [::std::mem::offset_of!(whisper_full_params, encoder_begin_callback) - 216usize];
    ["Offset of field: whisper_full_params::encoder_begin_callback_user_data"]
        [::std::mem::offset_of!(whisper_full_params, encoder_begin_callback_user_data) - 224usize];
    ["Offset of field: whisper_full_params::abort_callback"]
        [::std::mem::offset_of!(whisper_full_params, abort_callback) - 232usize];
    ["Offset of field: whisper_full_params::abort_callback_user_data"]
        [::std::mem::offset_of!(whisper_full_params, abort_callback_user_data) - 240usize];
    ["Offset of field: whisper_full_params::logits_filter_callback"]
        [::std::mem::offset_of!(whisper_full_params, logits_filter_callback) - 248usize];
    ["Offset of field: whisper_full_params::logits_filter_callback_user_data"]
        [::std::mem::offset_of!(whisper_full_params, logits_filter_callback_user_data) - 256usize];
    ["Offset of field: whisper_full_params::grammar_rules"]
        [::std::mem::offset_of!(whisper_full_params, grammar_rules) - 264usize];
    ["Offset of field: whisper_full_params::n_grammar_rules"]
        [::std::mem::offset_of!(whisper_full_params, n_grammar_rules) - 272usize];
    ["Offset of field: whisper_full_params::i_start_rule"]
        [::std::mem::offset_of!(whisper_full_params, i_start_rule) - 280usize];
    ["Offset of field: whisper_full_params::grammar_penalty"]
        [::std::mem::offset_of!(whisper_full_params, grammar_penalty) - 288usize];
    ["Offset of field: whisper_full_params::vad"]
        [::std::mem::offset_of!(whisper_full_params, vad) - 292usize];
    ["Offset of field: whisper_full_params::vad_model_path"]
        [::std::mem::offset_of!(whisper_full_params, vad_model_path) - 296usize];
    ["Offset of field: whisper_full_params::vad_params"]
        [::std::mem::offset_of!(whisper_full_params, vad_params) - 304usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn whisper_full_n_top_candidates(
        ctx: *mut whisper_context,
        i_segment: ::std::os::raw::c_int,
        i_token: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
...
unsafe extern "C" {
    pub fn whisper_full_n_top_candidates_from_state(
        state: *mut whisper_state,
        i_segment: ::std::os::raw::c_int,
        i_token: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
...
unsafe extern "C" {
    pub fn whisper_full_get_top_candidate(
        ctx: *mut whisper_context,
        i_segment: ::std::os::raw::c_int,
        i_token: ::std::os::raw::c_int,
        i_candidate: ::std::os::raw::c_int,
    ) -> whisper_token_candidate;
}
unsafe extern "C" {
    pub fn whisper_full_get_top_candidate_from_state(
        state: *mut whisper_state,
        i_segment: ::std::os::raw::c_int,
        i_token: ::std::os::raw::c_int,
        i_candidate: ::std::os::raw::c_int,
